...
class SimpleDate {
    ...
    constructor(date, strict, settings) {
        ...
        this.settings = {
            offset: (settings === null || settings === void 0 ? void 0 : settings.offset) !== undefined ? settings === null || settings === void 0 ? void 0 : settings.offset : ((_a = this.date) === null || _a === void 0 ? void 0 : _a.getTimezoneOffset()) || 0,
     ...
     */
    isSame(date, unitIsSame, sameYear = true, strict = false) {
        var _a, _b;
        let result = false;
        if (this.date) {
     ...
     */
    isAfter(date, unit, tolerance = 0, strict = false) {
        let response = false;
        if (this.date) {
            if (!(date instanceof Date && !isNaN(date.getTime()))) {
                if (date) {
     ...
     */
    isSameOrAfter(date, unit, strict = false) {
        let response = false;
        if (this.date) {
            if (!(date instanceof Date && !isNaN(date.getTime()))) {
                if (date) {
     ...
     */
    isBefore(date, unit, tolerance = 0, strict = false) {
        let response = false;
        if (strict && !date) {
            return false;
        }
     ...
     */
    isSameOrBefore(date, unit, strict = false) {
        let response = false;
        if (this.date) {
            if (!(date instanceof Date && !isNaN(date.getTime()))) {
                if (date) {
     ...
     */
    isBetween(from, to, unit, equal = true, strict = false) {
        if (strict && (!from || !to)) {
            return false;
        }
    ...
    format(format) {
        ...
        if (this.date) {
            ...
            if (format) {
                ...
                const isoString = date.toISOString(), month = new Date(Date.UTC(2000, parseInt(isoString.substring(5, 7), 10) - 1, 15)), weekday = new Date(Date.UTC(2000, 0, 2 + new Date(isoString).getUTCDay()));
    ...
    set(unitsOrOptions, value) {
        const newDate = this.date ? new Date(this.date) : new Date();
        const clamp = (val, max) => val < 0 ? 0 : val > max ? max : val;
        const apply = (options) => {
            if ((options === null || options === void 0 ? void 0 : options.month) !== undefined) {
                newDate.setMonth(options.month - 1);
            }
            if ((options === null || options === void 0 ? void 0 : options.year) !== undefined) {
                newDate.setFullYear(options.year);
            }
            if ((options === null || options === void 0 ? void 0 : options.day) !== undefined) {
                newDate.setDate(options.day);
            }
            if ((options === null || options === void 0 ? void 0 : options.hours) !== undefined) {
                newDate.setHours(clamp(options.hours, 23));
            }
            if ((options === null || options === void 0 ? void 0 : options.minutes) !== undefined) {
                newDate.setMinutes(clamp(options.minutes, 59));
            }
            if ((options === null || options === void 0 ? void 0 : options.seconds) !== undefined) {
                newDate.setSeconds(clamp(options.seconds, 59));
            }
            if ((options === null || options === void 0 ? void 0 : options.milliseconds) !== undefined) {
                newDate.setMilliseconds(options.milliseconds);
            }
        };
        if (typeof unitsOrOptions === 'string') {
            const mapped = {};
            switch (unitsOrOptions) {
                case 'year':
                    mapped.year = value;
                    break;
                case 'month':
                ...
                case 'minutes':
                case 'minute':
                    mapped.minutes = value;
                    break;
                case 'seconds':
                case 'second':
                    mapped.seconds = value;
                    break;
                case 'milliseconds':
                case 'millisecond':
                    mapped.milliseconds = value;
                    break;
            }
            apply(mapped);
        }
        else {
            apply(unitsOrOptions);
        }
        this.date = newDate;
        return new SimpleDate(this.date, true, this.settings);
    }
}
