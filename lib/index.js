    ...
    add(value, type) {
        ...
        if (this.date) {
            switch (type) {
                case 'years':
                case 'year':
                    newDate.date.setFullYear(Math.abs(newDate.date.getFullYear() + +value));
                    break;
                case 'months':
                case 'month':
                    newDate.date.setMonth(Math.abs(newDate.date.getMonth() + +value));
                    break;
                case 'weeks':
                case 'week':
                    newDate.date.setDate(Math.abs(newDate.date.getDate() + (7 * +value)));
                    break;
                case 'days':
                case 'day':
                    newDate.date.setDate(Math.abs(newDate.date.getDate() + +value));
                    break;
                case 'hours':
                case 'hour':
                    newDate.date.setHours(Math.abs(newDate.date.getHours() + +value));
                    break;
                case 'minutes':
                case 'minute':
                    newDate.date.setMinutes(Math.abs(newDate.date.getMinutes() + +value));
                    break;
                case 'seconds':
                case 'second':
                    newDate.date.setSeconds(Math.abs(newDate.date.getSeconds() + +value));
                    break;
                case 'milliseconds':
                case 'millisecond':
                    newDate.date.setMilliseconds(Math.abs(newDate.date.getMilliseconds() + +value));
                    break;
            }
        }
        return newDate;
