...
class SimpleDate {
    constructor(date, strict, settings) {
        ...
        this.settings = {
            ...
            locale: (settings === null || settings === void 0 ? void 0 : settings.locale) ? settings === null || settings === void 0 ? void 0 : settings.locale : resolvedTimeOptions.locale,
            timeZone: (settings === null || settings === void 0 ? void 0 : settings.timeZone) ? settings === null || settings === void 0 ? void 0 : settings.timeZone : resolvedTimeOptions.timeZone,
        };
    }
    padTo2Digits(number) {
        var _a;
